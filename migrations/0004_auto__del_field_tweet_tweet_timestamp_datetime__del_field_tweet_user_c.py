...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tweet.tweet_timestamp_datetime'
        db.delete_column(u'tweetnet_tweet', 'tweet_timestamp_datetime')

        # Deleting field 'Tweet.user_created_datetime'
        db.delete_column(u'tweetnet_tweet', 'user_created_datetime')

        # Adding field 'Tweet.tweet_timestamp_dt'
        db.add_column(u'tweetnet_tweet', 'tweet_timestamp_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tweet.user_created_dt'
        db.add_column(u'tweetnet_tweet', 'user_created_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tweet.tweet_timestamp_datetime'
        db.add_column(u'tweetnet_tweet', 'tweet_timestamp_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tweet.user_created_datetime'
        db.add_column(u'tweetnet_tweet', 'user_created_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Tweet.tweet_timestamp_dt'
        db.delete_column(u'tweetnet_tweet', 'tweet_timestamp_dt')

        # Deleting field 'Tweet.user_created_dt'
        db.delete_column(u'tweetnet_tweet', 'user_created_dt')
    ...
    models = {
        u'tweetnet.tweet': {
            ...
            'tweet_timestamp_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'user_created_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
